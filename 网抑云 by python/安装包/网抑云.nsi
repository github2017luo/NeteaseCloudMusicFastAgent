...
!define MUI_FINISHPAGE_RUN "$INSTDIR\ÍøÒÖÔÆ(python).exe"
...
Section "MainSection" SEC01
  ...
  File "E:\ÍøÒÖÔÆ\UnblockNeteaseMusic\ÍøÒÖÔÆ(python).exe"

; Shortcuts
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
  CreateDirectory "$SMPROGRAMS\$ICONS_GROUP"
;  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\ÍøÒÖÔÆ.lnk" "$INSTDIR\ÍøÒÖÔÆ(python).exe"
  
; ÉèÖÃ¿ª»ú×ÔÆô
  CreateShortCut "$STARTMENU\Programs\Startup\ÍøÒÖÔÆ.lnk" "$INSTDIR\ÍøÒÖÔÆ(python).exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\ÍøÒÖÔÆ(python).exe"
